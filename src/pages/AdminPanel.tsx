   ...
   return (
      <div className="space-y-6">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
               <h2 className="text-2xl font-display font-bold text-slate-800">Admin Control Panel</h2>
            ...
            <div className="flex glass p-1 rounded-xl">
               <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition ${activeTab === 'users' ? 'bg-gradient-to-r from-sky-500 to-teal-500 text-white shadow-lg shadow-sky-500/20' : 'text-slate-600 hover:bg-slate-50'}`}
               >
                  Users
               </button>
               <button
                  onClick={() => setActiveTab('departments')}
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition ${activeTab === 'departments' ? 'bg-gradient-to-r from-sky-500 to-teal-500 text-white shadow-lg shadow-sky-500/20' : 'text-slate-600 hover:bg-slate-50'}`}
               >
                  Departments
               </button>
               <button
                  onClick={() => setActiveTab('logs')}
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition ${activeTab === 'logs' ? 'bg-gradient-to-r from-sky-500 to-teal-500 text-white shadow-lg shadow-sky-500/20' : 'text-slate-600 hover:bg-slate-50'}`}
               >
                  Audit Logs
               </button>
               <button
                  onClick={() => setActiveTab('system')}
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition ${activeTab === 'system' ? 'bg-gradient-to-r from-sky-500 to-teal-500 text-white shadow-lg shadow-sky-500/20' : 'text-slate-600 hover:bg-slate-50'}`}
               >
                  System Health
               </button>
            </div>
         ...
         {activeTab === 'users' && (
            <div className="glass-card rounded-2xl overflow-hidden">
               <div className="p-4 border-b border-slate-200/50 bg-gradient-to-r from-slate-50 to-sky-50/30 flex flex-col md:flex-row gap-4 justify-between items-center">
                  <div className="flex gap-2 items-center">
                     <div className="relative">
                        ...
                        <input
                           ...
                           className="pl-9 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-sky-100 focus:border-sky-300 transition-all w-64"
                        />
                     </div>
                     <div className="relative">
                        <select
                  ...
                  <button
                     ...
                     className="flex items-center gap-2 bg-gradient-to-r from-sky-500 to-teal-500 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:from-sky-600 hover:to-teal-600 transition-all shadow-lg shadow-sky-500/20"
                  >
               ...
               <div className="overflow-x-auto">
                  <table className="w-full text-left">
                     <thead className="bg-slate-50/80 text-slate-400 text-xs uppercase font-semibold tracking-wider">
                        <tr>
                     ...
                     <tbody className="divide-y divide-slate-100">
                        {filteredStaff.map(staff => (
                           <tr key={staff.id} className="hover:bg-sky-50/50 transition-colors">
                              <td className="px-6 py-4">
                                 <div className="flex items-center gap-3">
                                    <img src={staff.avatarUrl} alt="" className="w-8 h-8 rounded-full bg-slate-200" />
                                    <span className="text-sm font-display font-bold text-slate-900">{staff.name}</span>
                                 </div>
                              </td>
                              ...
                              <td className="px-6 py-4">
                                 <span className={`px-2 py-1 rounded text-xs font-bold ${staff.status === 'Active' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-500'
                                    }`}>
                                    {staff.status}
                                 </span>
                              </td>
                  ...
                  <div className="p-6 grid grid-cols-2 gap-4">
                     ...
                     <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                        <div className="flex items-center gap-2 mb-2">
                           ...
                           <span className="text-sm font-bold text-emerald-700">Healthy Stock</span>
                        </div>
                        <p className="text-2xl font-bold text-emerald-800">{medicines.length - lowStockCount}</p>
                        <p className="text-xs text-emerald-600 mt-1">Items available</p>
                     </div>
                  </div>
               </div>
         ...
         {activeTab === 'system' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 text-white rounded-full flex items-center justify-center mb-4 shadow-lg shadow-emerald-500/20">
                     <Database size={24} />
                  </div>
                  <h3 className="font-display font-bold text-slate-800">Database Connection</h3>
               ...
               <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-blue-500 text-white rounded-full flex items-center justify-center mb-4 shadow-lg shadow-sky-500/20">
                     <Server size={24} />
                  </div>
                  <h3 className="font-display font-bold text-slate-800">API Gateway</h3>
               ...
               <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center text-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-violet-500 text-white rounded-full flex items-center justify-center mb-4 shadow-lg shadow-purple-500/20">
                     <Shield size={24} />
                  </div>
                  <h3 className="font-display font-bold text-slate-800">Data Backup</h3>
               ...
               <div className="md:col-span-3 bg-gradient-to-br from-slate-900 to-indigo-900 rounded-2xl p-6 text-white font-mono text-sm border border-slate-700/50">
         ...
         {activeTab === 'logs' && (
            <div className="glass-card rounded-2xl overflow-hidden">
               <div className="p-4 border-b border-slate-200/50 bg-gradient-to-r from-slate-50 to-sky-50/30 flex justify-between items-center">
                  <h3 className="font-display font-bold text-slate-800 flex items-center gap-2"><Activity size={18} /> Security Audit Trails</h3>
         ...
         {isModalOpen && (
            <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-50 flex items-center justify-center p-4">
               <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-scale-in border border-slate-200/50">
                  ...
                  <form onSubmit={handleAddUser} className="p-6 space-y-4">
                     {message && (
                        <div className={`p-3 rounded-xl text-sm mb-4 ${message.type === 'success' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-red-50 text-red-700 border border-red-200'
                           }`}>
                           {message.text}
                        </div>
                     )}
                     ...
                     <div className="pt-4 flex gap-3">
                        ...
                        <button
                           ...
                           className="flex-1 bg-gradient-to-r from-sky-500 to-teal-500 text-white px-4 py-2.5 rounded-xl text-sm font-semibold hover:from-sky-600 hover:to-teal-600 transition-all disabled:opacity-50 shadow-lg shadow-sky-500/20"
                        >
